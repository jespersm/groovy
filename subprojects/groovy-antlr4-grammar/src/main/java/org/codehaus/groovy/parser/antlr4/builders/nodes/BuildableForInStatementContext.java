 ...
 */
public class BuildableForInStatementContext extends BuildableBaseNode {
    private GroovyParser.ForInStatementContext ctx;

    public BuildableForInStatementContext(ASTBuilder astBuilder, GroovyParser.ForInStatementContext ctx) {
        super(astBuilder);
