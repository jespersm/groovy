 ...
 */
public class BuildableCastExpressionContext extends BuildableBaseNode {
    private GroovyParser.CastExpressionContext ctx;

    public BuildableCastExpressionContext(ASTBuilder astBuilder, GroovyParser.CastExpressionContext ctx) {
        super(astBuilder);
