 ...
 */
public class BuildableConstructorCallExpressionContext extends BuildableBaseNode {
    private GroovyParser.ConstructorCallExpressionContext ctx;

    public BuildableConstructorCallExpressionContext(ASTBuilder astBuilder, GroovyParser.ConstructorCallExpressionContext ctx) {
        super(astBuilder);
