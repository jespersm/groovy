 ...
 */
public class BuildableBlockStatementContext extends BuildableBaseNode {
    private GroovyParser.BlockStatementContext ctx;

    public BuildableBlockStatementContext(ASTBuilder astBuilder, GroovyParser.BlockStatementContext ctx) {
        super(astBuilder);
    ...
    public Statement build() {
        ...
        for (GroovyParser.StatementContext it : ctx.statement()) {
            astBuilder.unpackStatement(statement, astBuilder.parseStatement(it));
        }

        return astBuilder.setupNodeLocation(statement, ctx);
    }
}
