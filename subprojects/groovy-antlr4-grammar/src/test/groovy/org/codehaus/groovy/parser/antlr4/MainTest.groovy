...
//FIXME "56: no viable alternative at input '@ClosureParams(value=SimpleType.class' @ line 56, column 81."        "grails-shell/src/main/groovy/org/grails/cli/gradle/GradleUtil.groovy" | addIgnore([Parameter, IfStatement, ThrowStatement, ExpressionStatement, ReturnStatement, ForStatement, CaseStatement, FieldNode, PropertyNode, MethodNode, GenericsType], ASTComparatorCategory.LOCATION_IGNORE_LIST)
