...
//FIXME NullPointerException org.codehaus.groovy.parser.antlr4.ASTBuilder.parseCallExpressionRule(ASTBuilder.java:1650)        "grails-plugin-controllers/src/main/groovy/org/grails/plugins/web/controllers/ControllersGrailsPlugin.groovy" | addIgnore([Parameter, IfStatement, ThrowStatement, ExpressionStatement, FieldNode, PropertyNode, MethodNode], ASTComparatorCategory.LOCATION_IGNORE_LIST)
